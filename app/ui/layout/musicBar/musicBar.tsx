...
import MusicBarRight, {timeConvert} from "@/app/ui/layout/musicBar/right";
import {MusicOperation} from "@/app/ui/layout/musicBar/operation";
import {MusicInfo} from "@/app/ui/layout/musicBar/MusicInfo";
  ...
  return (
    <div className={"flex flex-col h-full w-full"}>
      ...
      <div className={"w-full flex flex-grow-[1] items-center justify-between py-0 px-10"}>
        <div className={"flex ml-0 w-60 bg-red-100"}>
